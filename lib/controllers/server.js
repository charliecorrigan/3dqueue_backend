...
app.post(baseAPI + '/admins', passport.authenticate('local-signup'), (request, response) => {
  console.log("Here at the admin page, like an adult.")
  console.log("Here is the request.query: ")
  console.log(request.query)
  console.log("Here is the request.body: ")
  console.log(request.body)
  const newAdminParams = request.body
  database.raw(`INSERT INTO admins (username, password, created_at)
  VALUES  (?, ?, ?) RETURNING *`,
  [newAdminParams.username, newAdminParams.password, new Date])
